...
namespace Oauth2Login.Service
{
    public class PayPalService : IClientService
    {
        ...
        public string BeginAuthentication()
        {
            if (_client != null)
            {
                _oauthUrl = string.Format("https://www.sandbox.paypal.com/webapps/auth/protocol/openidconnect/v1/authorize?" +
        ...
        public string RequestToken()
        {
            ...
            if (code != null)
            {
                string oauthUrl = "https://api.sandbox.paypal.com/v1/identity/openidconnect/tokenservice";
        ...
        {
            string result = "";
            string profileUrl = string.Format("https://api.sandbox.paypal.com/v1/identity/openidconnect/userinfo/?schema=openid");
